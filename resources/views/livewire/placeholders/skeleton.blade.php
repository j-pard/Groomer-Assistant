            ...
            <div class="list-element mx-2 my-1 py-2 px-1 px-sm-3">
                <div class="d-flex flex-row col-md-5">
                    ...
                    <div class="d-flex flex-column text-end justify-content-between col-md-5">
                        ...
                        <div class="skeleton-cell"></div>
                        <div class="skeleton-cell cell-mobile"></div>
                    </div>
                </div>
                ...
                <div class="d-flex flex-column text-end justify-content-between align-items-end col-md-4">
                    <div class="skeleton-cell skeleton-cell-lg"></div>
                    <div class="skeleton-cell skeleton-cell-lg"></div>
                    <div class="skeleton-cell skeleton-cell-lg cell-mobile"></div>
                </div>
            </div>
        @endfor
    </div>
